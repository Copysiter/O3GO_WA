...
EVENT_MAP: Config = {
    ...
    'SCHEDULER': (5, {
        ...
        'JOB': (2, {
            'REGISTER': (1, 'Регистрация фоновой задачи'),
            'START': (2, 'Запуск фоновой задачи'),
            'SUCCESS': (3, 'Фоновая задача завершена успешно'),
            'FAILURE': (4, 'Задача завершилась с ошибкой'),
            'ERROR': (5, 'Ошибка при запуске фоновой задачи'),
        }),
    }),
    'MQTT': (6, {
        'CONNECTION': (1, {
